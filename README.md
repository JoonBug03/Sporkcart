...
- Can have two track inpus. Always merges, but can change between backwards input paths via redstone. (Only supports default and default invisible tracks directly attached to it)
